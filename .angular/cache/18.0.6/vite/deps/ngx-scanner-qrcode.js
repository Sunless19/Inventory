...
var _NgxScannerQrcodeService = class _NgxScannerQrcodeService {
  /**
   * loadFiles
   * @param files
   * @param percentage
...
_NgxScannerQrcodeService.ɵfac = function NgxScannerQrcodeService_Factory(t) {
  return new (t || _NgxScannerQrcodeService)();
};
_NgxScannerQrcodeService.ɵprov = ɵɵdefineInjectable({
  token: _NgxScannerQrcodeService,
  factory: _NgxScannerQrcodeService.ɵfac,
  providedIn: "root"
});
var NgxScannerQrcodeService = _NgxScannerQrcodeService;
(() => {
...
var _NgxScannerQrcodeComponent = class _NgxScannerQrcodeComponent {
...
_NgxScannerQrcodeComponent.ɵfac = function NgxScannerQrcodeComponent_Factory(t) {
  return new (t || _NgxScannerQrcodeComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef));
};
_NgxScannerQrcodeComponent.ɵcmp = ɵɵdefineComponent({
...
var NgxScannerQrcodeComponent = _NgxScannerQrcodeComponent;
(() => {
...
var _NgxScannerQrcodeModule = class _NgxScannerQrcodeModule {
};
_NgxScannerQrcodeModule.ɵfac = function NgxScannerQrcodeModule_Factory(t) {
  return new (t || _NgxScannerQrcodeModule)();
};
_NgxScannerQrcodeModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxScannerQrcodeModule,
  declarations: [NgxScannerQrcodeComponent],
  exports: [NgxScannerQrcodeComponent]
});
_NgxScannerQrcodeModule.ɵinj = ɵɵdefineInjector({
  providers: [NgxScannerQrcodeService]
});
var NgxScannerQrcodeModule = _NgxScannerQrcodeModule;
(() => {
